...
@section('content')     
    <div class="page-container-1" id="page-container">
        <div class="page-title padding pb-0 ">
            <h2 class="text-md mb-0" style="padding-bottom: 35px;">Category            
           
                <a href="{{ url('admin/addCategory') }}" class="btn btn-primary" style="float: right;">Add Category</a>         
           <!--
                ...
                <table class="table table-theme v-middle" data-plugin="bootstrapTable"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><span class="text-muted">Restaurantes asignados</span></th>
                    ...
                    <tbody>
                        @foreach ($categories as $user)
                            <tr>
                                ...
                                <td>
                                <img src="{{ url($user->image) }}" style="background:gray"/>
                                </td>                                                            
                                ...
                                <td >
                                    ...
                                    <a href="{{ url('admin/editCategory', $user->id)}}" class="btn btn-primary mr-3" >Edit</a>                                    
