...
@section('content')     
    <div class="page-container-1" id="page-container">
        <div class="page-title padding pb-0 ">
            <h2 class="text-md mb-0" style="padding-bottom: 35px;">Notifications            
           
                <a href="{{ url('notification/add') }}" class="btn btn-primary" style="float: right;">Add Notification</a>         
           <!--
                        ...
                        @foreach ($notifications as $user)
                            <tr>
                                ...
                                <td >
                                    ...
                                    <a href="{{ url('notification/edit', $user->id)}}" class="btn btn-primary mr-3" >Edit</a>                                    
                                    <button onclick="deleteUser({{$user->id}})" class="btn btn-primary mr-3" data-toggle="modal" data-target="#m">Delete</button>
                                    <button onclick="send({{$user->id}})" class="btn btn-primary" data-toggle="modal" data-target="#mm">Send</button>
                                    </div>
...
<div id="mm" class="modal" data-backdrop="true">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title">Are you sure to send push notification?</h5>
        </div>
        <!-- <div class="modal-body text-center p-lg">
        <p></p>
        </div> -->
        <div class="modal-footer">
        <button type="button" class="btn btn-primary" data-dismiss="modal">No</button>
        <button id="sendPush" type="button" class="btn btn-primary delBtn" data-dismiss="modal">Yes</button>
        </div>
    </div><!-- /.modal-content -->
    </div>
</div>
...
<script type="text/javascript">   
    ...
    $("#delBtn").click(function(){    
        ...
        $.ajax({
          type: 'POST',
          data: { id:id},
          url: "{{ URL::to('api/deleteNotification')}}",
