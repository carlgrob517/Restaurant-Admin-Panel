...
@section('content')     
    <div class="page-container-1 padding" id="page-container">
        <div class="page-title padding pb-0 ">
            <h2 class="text-md mb-0" style="padding-bottom: 35px;">Slide Shows            
            
            <a href="{{ url('admin/addSlideshow') }}" class="btn btn-primary" style="float: right;">Add Slideshow</a>         
            <!--
        ...
        <div class="padding card pt-5 ">
            <div class="table-responsive">
                ...
                <table class="table table-theme v-middle" data-plugin="bootstrapTable"
                    ...
                    <thead>
                        <tr>
                            <th><span class="text-muted">Titlte</span></th>
                    ...
                    <tbody>
                        @foreach ($slideshow as $user)
                            <tr>
                                <td>
                                {{$user->title}}
                                </td>
                                <td>                                
                                <img src="{{ url($user->image) }}" style="width:200px;height:150px;"/>
                                </td>                                                            
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/editSlideshow', $user->id)}}" class="btn btn-primary mr-3" >Edit</a>                                    
...
<script type="text/javascript">   
    ...
    $("#delBtn").click(function(){    
        ...
        $.ajax({
          type: 'POST',
          data: { id:id},
          url: "{{ URL::to('api/deleteSlideshow')}}",
    ...
    function onClickStatus(cb){
        ...
        $.ajax({
          ...
          url: "{{ URL::to('api/updateSlideStatus')}}",
          success: function(result) {     
                var res = result.results;
                if(res == 200){
                    //location.reload();
